...
async function getAudio() {
  ...
  source.connect(analyzer); // HOW FREQUENTLY DO YOU WANT TO COLLECT DATA
...
function drawTimedata(timeData) {
  ...
  analyzer.getByteTimeDomainData(timeData); //TURN DATA INTO SOMETHING VISUAL
  // 1. CLEAR THE CANVAS (TODO)

  ctx.clearRect(0, 0, WIDTH, HEIGHT); //2. SETUP CANVAS DRAWING
  ...
  ctx.stroke(); //CALL ITSELF ASSOON AS POSSIBLE
...
function drawFreqency(frequencyData) {
  ...
  analyzer.getByteFrequencyData(frequencyData); // consoe.log(frequencyData);
  //CALCULATE THE BAR WIDTH

  const barWidth = WIDTH / bufferLength * 2.5; // console.log(barWidth);
  ...
  frequencyData.forEach(amount => {
    ...
    const barHeight = HEIGHT * percent; //CONVERT THE COLOR TO HSL (TODO)
...
;
getAudio();
},{"./utils.js":"utils.js","regenerator-runtime":"node_modules/regenerator-runtime/runtime.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
