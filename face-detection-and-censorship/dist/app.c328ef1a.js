...
var canvas = document.querySelector('.video'); // const ctx = canvas.getContext('2d');

var faceCanvas = document.querySelector('.face'); // const faceCtx = faceCanvas.getContext('2d');

var faceDetector = new window.FaceDetector(); // POPULATE THE VIDEO AND PLAY IT
...
function _populateVideo() {
  _populateVideo = _asyncToGenerator(
  /*#__PURE__*/
